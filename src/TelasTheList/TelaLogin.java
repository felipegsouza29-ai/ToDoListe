...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private static final String usuario = "Felipinho";
    private static final String senha = "2516";
    /**
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(jTextFieldUsuario.getText().equals(usuario) && jPasswordFieldSenha.getText().equals(senha)){
            JOptionPane.showMessageDialog(null,"usuario cadasdratrado bem vindo :3");
            
            MyOneScreamen myOneScreamen = new MyOneScreamen();
            MyOneScreamen.setVisible(true);
